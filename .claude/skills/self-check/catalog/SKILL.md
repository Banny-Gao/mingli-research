...
description: catalog 自检。检查 books/{slug}/catalog.md 的元信息（书名 `《》`、作者、版本、简介、术数、类别、内容类型）、2 列表格（编号+篇名）、路径一致性。遵守 shared/sources/SPEC-catalog.md + shared/sources/general.md。
---
...
1. `shared/sources/SPEC-catalog.md` 全文
