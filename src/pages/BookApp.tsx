        ...
        {modalType && (
          <div className="modal-backdrop" onClick={e => { if ((e.target as HTMLElement).classList.contains('modal-backdrop')) closeModal() }}>
            <div className="modal-card" style={{ maxHeight: '90vh' }}>
                  ...
                  {modalKey && (
                    <>
                      <button
                        ...
                        style={{
                          background: 'none', border: '1px solid var(--color-border-hover)', borderRadius: 6,
                      ...
                      <button
                        ...
                        style={{
                          background: 'none', border: '1px solid var(--color-border-hover)', borderRadius: 6,
                          padding: '4px 10px', cursor: 'pointer',
                          color: isBookmarked(modalKey) ? 'var(--color-gold)' : 'var(--color-text-dim)',
                          fontSize: 13, transition: 'all 0.2s',
                        }}
                      >
              ...
              {/* TOC - only for interp */}
              {modalType === 'interp' && <TableOfContents html={rawBody} scrollRef={modalBodyRef} />}
              ...
              {toolbarPos && (
                <AnnotationToolbar
                  ...
                  onClose={() => { setToolbarPos(null); setPendingSelection(null) }}
                />
              )}
