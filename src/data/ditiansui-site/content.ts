...
const sourceModules = import.meta.glob('../../../books/ditiansui-site/articles/*/source.md', {
  query: '?raw',
  import: 'default',
  eager: false,
})
const skillModules = import.meta.glob('../../../books/ditiansui-site/articles/*/skill.md', {
  query: '?raw',
  import: 'default',
  eager: false,
})

function extractPathKey(
  mod: Record<string, () => Promise<string>>,
  suffix: string
