...
<p>在收到八字四柱后，根据出生月份和全局五行组合，评估命局的整体寒暖状态（极寒、偏寒、适中、偏暖、极热），判断是否需要调候，以及调候用神是否有力。此技能应在格局分析和用神判断之前调用——调候需求会直接影响用神的选取。</p>
<h2>输入</h2>
<ul>
...
<h2>输出</h2>
<pre><code class="language-typescript">interface HanNuanReport {
  /** 命局气候基础 */
  climate: {
    birthSeason: &quot;春&quot; | &quot;夏&quot; | &quot;秋&quot; | &quot;冬&quot;;
