...
export default `<h2 id="功能">功能</h2><p>当需要分析一个人的兄弟姐妹运势（包括兄弟数量趋势、兄弟姐妹关系、比劫对日主的助害）时使用此技能。核心方法是：比肩为兄弟、劫财为姐妹，通过比劫的旺衰与日主的配合判断兄弟吉凶。此技能应在完成基础八字排盘（日主旺衰、用神喜忌）之后调用。</p>
<h2 id="输入">输入</h2><ul>
...
<h2 id="输出">输出</h2><pre><code class="language-typescript">interface XiongDiReport {
  /** 兄弟姐妹星 */
  siblingStar: {
    biJian: {              // 比肩（兄弟）
