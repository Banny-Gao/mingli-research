...
<p>在收到八字四柱并完成三元分析和干支配合分析后，确定命局的&quot;体&quot;（日主、形象或气局），然后根据任铁樵提出的十种用神法则选取对应的&quot;用&quot;（用神），并判断&quot;扶之抑之&quot;是否&quot;得其宜&quot;——即在极旺极弱时是否做了变通处理。此技能是格局判断和用神选取的核心技能。</p>
<h2>输入</h2>
<ul>
...
<h2>输出</h2>
<pre><code class="language-typescript">interface TiYongReport {
  /** 体的判定 */
  ti: {
    type: &quot;日主&quot; | &quot;形象&quot; | &quot;气局&quot; | &quot;化神&quot; | &quot;格象&quot;;
    description: string;
