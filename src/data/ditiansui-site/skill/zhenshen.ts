...
export default `<h2 id="功能">功能</h2><p>在收到八字四柱后，以月令提纲为出发点，识别&quot;得时秉令&quot;的当月当令之神（真神），判断其是否透出天干形成&quot;聚得真&quot;，再评估假神（失时退气之神）对真神的干扰程度，从而给出真神是否&quot;得用&quot;的结论。此技能应在格局判断之后、运程分析之前调用。</p>
<h2 id="输入">输入</h2><ul>
...
<h2 id="输出">输出</h2><pre><code class="language-typescript">interface ZhenShenReport {
  /** 月令信息 */
