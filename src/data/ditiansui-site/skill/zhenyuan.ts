...
export default `<h2 id="功能">功能</h2><p>在收到八字四柱和大运流年信息后，识别命局中五行极旺/极衰状态，判断是否处于&quot;贞下起元&quot;的转换节点，输出命局在时间轴上的循环周期分析。此技能适用于八字分析中对&quot;趋势转换&quot;的预判——用于回答&quot;好运会持续多久？坏运何时转好？&quot;这类循环性问题。</p>
<h2 id="输入">输入</h2><ul>
...
<h2 id="输出">输出</h2><pre><code class="language-typescript">interface ZhenYuanReport {
  /** 命局五行极值 */
  extremeElements: {
    element: string;          // 五行
    state: &quot;极旺&quot; | &quot;极衰&quot; | &quot;正常&quot;;
