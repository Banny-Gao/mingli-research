...
<p>在完成衰旺判定和月令分析后，对命局的五行之气进行更深层的&quot;源流&quot;分析。检查日主（或命局中心五行）的长生之位是否完整、根基是否稳固，判断命局的源深源浅，以及空亡对五行根基的影响。此技能揭示的不是&quot;日主强不强&quot;（衰旺层面），而是&quot;根基深不深&quot;（源流层面），适用于八字分析的进阶阶段。</p>
<h2>输入</h2>
<ul>
...
<h2>输出</h2>
<pre><code class="language-typescript">interface YuanLiuReport {
  /** 日主基础 */
  dayMaster: {
    stem: string;
    element: string;
