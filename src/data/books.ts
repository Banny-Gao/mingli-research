...
export const books: Book[] = [
  ...
  },
  {
    ...
    "author": "[民国]韦千里",
    "version": "网络整理本",
    "description": "民国命理大家韦千里 1946 年所著，把十天干 × 十二月 × 十二时辰的 1440 种日柱基本组合，按\"日干为主、月支为提纲、时辰为归宿\"立成一套可按图索骥的八字速查手册，民国以来几乎是子平学子的案头必备工具书。",
    ...
    "chapters": [
      {
        ...
        "name": "原书十卷凡例",
        "isDone": false,
        "category": "卷一（看命总法 · 格局 · 用神 · 六亲 · 女命小儿）"
      },
      {
        "num": "002",
        "name": "袁序",
